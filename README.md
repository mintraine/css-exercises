# My CSS Exercises (The Odin Project)

This repository contains my solutions to the CSS practice exercises from [The Odin Project](https://www.theodinproject.com/).

The original instructions from TOP are included below for reference.
